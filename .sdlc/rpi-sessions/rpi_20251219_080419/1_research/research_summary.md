...
**Objective**: 
You are a Senior Full-Stack Engineer. Complete the following SDLC workflow for Issue AGENTIC-149.
...
- Repo: django-amazon-clone-test (Branch: feature/agentic_149)
...
6. **QA Reporting**:
   ...
   - Issue ID: AGENTIC-149
   - Project ID: Get from 'mcp__sdlc-tools__get_project_context' if needed

7. **Delivery**: 
   - Commit changes (use git commit with descriptive message)
   - Push branch to remote (git push origin feature/agentic_149)
   - Use 'open_github_pr' tool to submit your work
   - PR title should reference the issue: "AGENTIC-149: Highlight active sort option on list pages"
...
- **dependency_check**: Comprehensive dependency analysis reveals a Django e-commerce project with moderate complexity. Key concerns include potential version mismatches, security configuration risks, and unmanaged transitiv...
