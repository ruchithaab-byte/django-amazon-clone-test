...
- **dependency_check**: title='Clean Up Import Statements' description='Modify AdminViews.py import for messages to use django.contrib directly' priority=<Priority.P3: 'P3'> assignee=None due_date=None files=[FileReference(p...
- **dependency_check**: title='Pin Dependency Versions' description='Update requirements.txt with exact package versions for production stability' priority=<Priority.P2: 'P2'> assignee=None due_date=None files=[FileReference...
