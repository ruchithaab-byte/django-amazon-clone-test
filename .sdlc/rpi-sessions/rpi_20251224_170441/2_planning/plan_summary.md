...
**Objective**: 
You are a Senior Full-Stack Engineer. Complete the following SDLC workflow for Issue AGENTIC-156.
...
- Repo: django-amazon-clone-test (Branch: feature/agentic_156)
...
6. **QA Reporting**:
   ...
   - Issue ID: AGENTIC-156
   - Project ID: Get from 'mcp__sdlc-tools__get_project_context' if needed

7. **Delivery**: 
   - Commit changes (use git commit with descriptive message)
   - Push branch to remote (git push origin feature/agentic_156)
   - Use 'open_github_pr' tool to submit your work
   - PR title should reference the issue: "AGENTIC-156: Add product count and pagination info display to product list page"
