...
**Objective**: 
You are a Senior Full-Stack Engineer. Complete the following SDLC workflow for Issue AGENTIC-141.
...
- Repo: django-amazon-clone-test (Branch: feature/agentic_141)
...
6. **QA Reporting**:
   ...
   - Issue ID: AGENTIC-141
   - Project ID: Get from 'mcp__sdlc-tools__get_project_context' if needed

7. **Delivery**: 
   - Commit changes (use git commit with descriptive message)
   - Push branch to remote (git push origin feature/agentic_141)
   - Use 'open_github_pr' tool to submit your work
   - PR title should reference the issue: "AGENTIC-141: Highlight active sort option on list pages"
...
### step_1: Update DjangoEcommerceApp/templates/admin_templates/merchant_list.html

- **File**: `DjangoEcommerceApp/templates/admin_templates/merchant_list.html`
- **Action**: modify
- **Details**: Dependency Analysis for Django Amazon Clone Test P
- **Test**: `make test`
