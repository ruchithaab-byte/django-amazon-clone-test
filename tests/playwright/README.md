...
# Set the password (must be 'testpass123')
...
1. Configure Django settings:
   - Use `console.EmailBackend` for password reset emails
   - Set up rate limiting for login API
   - Ensure login/logout/register views are at standard URLs
...
pytest tests/playwright/test_django_auth.py
```
