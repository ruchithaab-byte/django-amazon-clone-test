...
class TestAuthentication:
    ...
    def test_login_invalid_credentials(self, page: Page, server_url):
    ...
    def test_logout_functionality(self, page: Page, server_url):
...
class TestRegistration:
    ...
    def test_user_registration(self, page: Page, server_url):
        ...
        page.goto(f"{server_url}/auth/register/")
...
class TestPasswordReset:
    ...
    def test_password_reset_request(self, page: Page, server_url):
        """Test password reset request functionality"""
        page.goto(f"{server_url}/auth/password-reset/")
...
class TestAPIRateLimit:
    ...
    def test_api_rate_limit_enforcement(self, page: Page, server_url):
        """Test that API rate limiting returns 429 when exceeded"""

        # Test rapid API calls to trigger rate limit
        api_endpoint = f"{server_url}/api/auth/login/"
    ...
    def test_rate_limit_retry_after_header(self, page: Page, server_url):
